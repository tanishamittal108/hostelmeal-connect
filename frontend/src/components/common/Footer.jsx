      ...
      <div className="container-app py-16">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display font-bold text-xl text-white">
                HostelMeal<span className="text-primary-400">Connect</span>
              </span>
            </div>
            <p className="text-sm text-gray-400 max-w-xs leading-relaxed">
              Connecting hostel students with home chefs for authentic,
              nutritious, and affordable daily meals. Ghar jaisa khana, hostel
              tak! 🏠❤️
            </p>
        ...
        <div className="mt-12 pt-6 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-500">
            © {new Date().getFullYear()} HostelMeal Connect. All rights
            reserved.
          </p>
